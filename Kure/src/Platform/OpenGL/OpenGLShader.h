...
namespace Kure {
	...
	public:
		...
		virtual void SetIntArray(int* value, uint32_t count, const std::string& name) override;
	...
	public: //uniform uploads
		void UploadUniformIntArray(int* value, uint32_t count, const std::string& name) const;
